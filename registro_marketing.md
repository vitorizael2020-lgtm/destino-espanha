...
### 2026-07-10
- 🧭 **ESTRATÉGIA 2.0 (decisão do Vitor): PASSAGENS viram o FOCO; vistos continuam como backend premium.** Racional: ciclo de venda de dias (vs semanas/meses do visto), margem ~R$1.800–2.600/venda, demanda macro aquecida (ano eleitoral → fluxo migratório). Vendas reais já fechadas: Richard e Daniel (R$4.200,78 cada).
